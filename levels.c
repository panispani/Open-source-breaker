...
void initialise_levels() {
    memcpy(bricks_level[0], level1, sizeof(int) * BRICKS_PER_LEVEL);
    memcpy(bricks_level[1], level2, sizeof(int) * BRICKS_PER_LEVEL);
    memcpy(bricks_level[2], level3, sizeof(int) * BRICKS_PER_LEVEL);
    memcpy(bricks_level[3], level4, sizeof(int) * BRICKS_PER_LEVEL);
}
