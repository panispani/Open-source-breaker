...
void initialise_levels() {
    memcpy(bricks_level[0], level1, BRICKS_PER_LEVEL);
    memcpy(bricks_level[1], level2, BRICKS_PER_LEVEL);
    memcpy(bricks_level[2], level3, BRICKS_PER_LEVEL);
    memcpy(bricks_level[3], level4, BRICKS_PER_LEVEL);
}
